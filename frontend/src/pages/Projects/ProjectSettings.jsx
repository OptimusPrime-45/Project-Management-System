...
// canEditProject: only super admins can edit/delete the project itself
const ProjectSettings = ({ project, onEdit, onDelete, canEditProject = false }) => {
			...
			<section className="rounded-2xl border border-border bg-card p-6 space-y-4">
				<div>
					...
					<p className="text-sm text-muted-foreground">
						{canEditProject ? "Update the core project details." : "View the core project details."}
					</p>
				</div>
